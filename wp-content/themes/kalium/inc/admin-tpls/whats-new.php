...
<div class="kalium-whats-new">
	...
	<div class="feature-section two-col">
        ...
        <div class="col">
            <a href="https://demo.kaliumtheme.com/law/" target="_blank"><img src="<?php echo kalium()->assetsUrl( 'images/admin/whats-new/law-demo.jpg' ); ?>"></a>
            <h3>Law demo</h3>
            <p>
                Demo that features law and jurisdiction concept in an elegant and organized way.

                <br>
                <a href="https://demo.kaliumtheme.com/law/" target="_blank">Click to preview &raquo;</a>
            </p>
        </div>
	</div>
